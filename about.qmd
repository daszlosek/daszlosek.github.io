---
title: "About Me"
image: profile2_lookdown150.jpg
about:
  template: trestles
  links:
    - icon: twitter
...
Since 2017, I've held the position of Biostatistician at [IDEXX Laboratories](https://www.idexx.com/en/) within the Medical Data Insights team. My responsibilities predominantly revolve around three main domains:

1.  Clinical Studies
2.  Real World Evidence (RWE) Studies
3.  Validation Studies for machine learning algorithms

As part of my work, I collaborate with over 40 universities and research institutions across 20 different countries:

![](002_world-collaboration-map.png)
